...
!=======================================================
      ...
      do imovie=1,nmovie
          do iatom=1,natoms
              if (trim(atom_type(iatom)) .eq. 'O' &
                 .and. x(iatom,imovie) .lt. l_9)then
                     i=i+1      
                     ndx_OW_l9(i)=iatom
              endif
          enddo 
      ...
      do imovie=1,nmovie
          do iatom=1,natoms
              if (trim(atom_type(iatom)) .eq. 'O' &
                 .and. x(iatom,imovie) .lt. l_10)then
                     i=i+1      
                     ndx_OW_l10(i)=iatom
              endif
          enddo 
...
!====================================
      ...
      enddo
      close(20)
      open(20,file=trim(filename)//'_l9_list.dat')
      ...
      enddo
      close(20)
      open(20,file=trim(filename)//'_l10_list.dat')
