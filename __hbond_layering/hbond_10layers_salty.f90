...
!========================
      ...
      real           :: r23,r13,l_1,l_2,l_3,l_4,l_5,l_6,l_7,l_8,l_9,l_10
      integer    :: begin_time,end_time,rat,i,j,nmovie,natoms,iatom,& 
                    ...
                    i_OW_l7,i_OW_l8,i_OW_l9,i_OW_l10,&
                    i1,i2,ii,iii,iiii,i5,i6,i7,i_OW
      logical    :: hbonded      
      ...
      integer,allocatable,dimension (:)          :: ndx_OW,ndx_H,&
          ...
          ndx_OW_l6,ndx_OW_l7,ndx_OW_l8,ndx_OW_l9,ndx_OW_l10,ndx_Li
...
!==================
      ...
      write(6,*)'What is normal coordinate of 1st layer (SALTY water):'
      read(5,*)l_1!unit: Angstrom
      ...
      do imovie=1,nmovie
          ...
          do iatom= 1,natoms
              ...
              if (trim(atom_type(iatom)) .eq. 'O' .and.&
                  x(iatom,imovie) .gt. l_1) then
                  i=i+1
              endif
          enddo
      enddo
      i_OW_l1=i
      write(6,*)'Number of Ow at first 1A layer','    Number of Hw'
      write(6,*)i_OW_l1,i_H
      close(10)
      !=======
      !layer 2      
      ...
      do imovie=1,nmovie
          ...
          do iatom= 1,natoms
              read (10,*)atom_type(iatom),x(iatom,imovie),& 
                       y(iatom,imovie),z(iatom,imovie)
              if (trim(atom_type(iatom)) .eq. 'O' .and.&
                  x(iatom,imovie) .gt. l_2) then
                  i=i+1
              endif
          enddo
      enddo
      i_OW_l2=i
      write(6,*)'Number of Ow at first 2A layer','    Number of Hw'
      write(6,*)i_OW_l2,i_H
      close(10)
      !=======
      !layer 3      
      ...
      do imovie=1,nmovie
          ...
          do iatom=1,natoms
              read (10,*)atom_type(iatom),x(iatom,imovie),& 
                       y(iatom,imovie),z(iatom,imovie)
              if (trim(atom_type(iatom)) .eq. 'O' .and.&
                  x(iatom,imovie) .gt. l_3) then
                  i=i+1
              endif
          enddo
      enddo
      i_OW_l3=i
      write(6,*)'Number of Ow at first 3A layer','    Number of Hw'
      write(6,*)i_OW_l3,i_H
      close(10)
      !=======
      !layer 4      
      ...
      do imovie=1,nmovie
          ...
          do iatom= 1,natoms
              read (10,*)atom_type(iatom),x(iatom,imovie),& 
                       y(iatom,imovie),z(iatom,imovie)
              if (trim(atom_type(iatom)) .eq. 'O' .and.&
                  x(iatom,imovie) .gt. l_4) then
                  i=i+1
              endif
          enddo
      enddo
      i_OW_l4=i
      write(6,*)'Number of Ow at first 4A layer','    Number of Hw'
      write(6,*)i_OW_l4,i_H
      close(10)
      !=======
      !layer 5      
      ...
      do imovie=1,nmovie
          ...
          do iatom= 1,natoms
              read (10,*)atom_type(iatom),x(iatom,imovie),& 
                       y(iatom,imovie),z(iatom,imovie)
              if (trim(atom_type(iatom)) .eq. 'O' .and.&
                  x(iatom,imovie) .gt. l_5) then
                  i=i+1
              endif
          enddo
      enddo
      i_OW_l5=i
      write(6,*)'Number of Ow at first 5A layer','    Number of Hw'
      write(6,*)i_OW_l5,i_H
      close(10)
      !=======
      !layer 6      
      ...
      do imovie=1,nmovie
          ...
          do iatom= 1,natoms
              read (10,*)atom_type(iatom),x(iatom,imovie),& 
                       y(iatom,imovie),z(iatom,imovie)
              if (trim(atom_type(iatom)) .eq. 'O' .and.&
                  x(iatom,imovie) .gt. l_6) then
                  i=i+1
              endif
          enddo
      enddo
      i_OW_l6=i
      write(6,*)'Number of Ow at first 6A layer','    Number of Hw'
      write(6,*)i_OW_l6,i_H
      close(10)
      !=======
      !layer 7      
      ...
      do imovie=1,nmovie
          ...
          do iatom= 1,natoms
              read (10,*)atom_type(iatom),x(iatom,imovie),& 
                       y(iatom,imovie),z(iatom,imovie)
              if (trim(atom_type(iatom)) .eq. 'O' .and.&
                  x(iatom,imovie) .gt. l_7) then
                  i=i+1
              endif
          enddo
      enddo
      i_OW_l7=i
      write(6,*)'Number of Ow at first 7A layer','    Number of Hw'
      write(6,*)i_OW_l7,i_H
      close(10)
      !=======
      !layer 8      
      ...
      do imovie=1,nmovie
          ...
          do iatom= 1,natoms
              read (10,*)atom_type(iatom),x(iatom,imovie),& 
                       y(iatom,imovie),z(iatom,imovie)
              if (trim(atom_type(iatom)) .eq. 'O' .and.&
                  x(iatom,imovie) .gt. l_8) then
                  i=i+1
              endif
          enddo
      enddo
      i_OW_l8=i
      write(6,*)'Number of Ow at first 8A layer','    Number of Hw'
      write(6,*)i_OW_l8,i_H
      close(10)
      !=======
      !layer 9      
      ...
      do imovie=1,nmovie
          ...
          do iatom= 1,natoms
              read (10,*)atom_type(iatom),x(iatom,imovie),& 
                       y(iatom,imovie),z(iatom,imovie)
              if (trim(atom_type(iatom)) .eq. 'O' .and.&
                  x(iatom,imovie) .gt. l_9) then
                  i=i+1
              endif
          enddo
      enddo
      i_OW_l9=i
      write(6,*)'Number of Ow at first 9A layer','    Number of Hw'
      write(6,*)i_OW_l9,i_H
      close(10)
      !=======
      !layer 10      
      ...
      do imovie=1,nmovie
          ...
          do iatom= 1,natoms
              read (10,*)atom_type(iatom),x(iatom,imovie),& 
                       y(iatom,imovie),z(iatom,imovie)
              if (trim(atom_type(iatom)) .eq. 'O' .and.&
                  x(iatom,imovie) .gt. l_10) then
                  i=i+1
              endif
          enddo
      enddo
      i_OW_l10=i
      write(6,*)'Number of Ow at first 10A layer','    Number of Hw'
      write(6,*)i_OW_l10,i_H
      close(10)
!=======================================================
...
!=======================================================
      ...
      allocate(ndx_OW_l9(i_OW_l9))
      allocate(ndx_OW_l10(i_OW_l10))
      i=0
      ii=0
      iii=0
      do iatom=1,natoms
...
!=======================================================
      ...
      do imovie=1,nmovie
          do iatom=1,natoms
              if (trim(atom_type(iatom)) .eq. 'O' &
                 .and. x(iatom,imovie) .gt. l_1)then
                     i=i+1      
                     ndx_OW_l1(i)=iatom
              endif
          enddo 
      ...
      do imovie=1,nmovie
          do iatom=1,natoms
              if (trim(atom_type(iatom)) .eq. 'O' &
                 .and. x(iatom,imovie) .gt. l_2)then
                     i=i+1      
                     ndx_OW_l2(i)=iatom
              endif
          enddo 
      ...
      do imovie=1,nmovie
          do iatom=1,natoms
              if (trim(atom_type(iatom)) .eq. 'O' &
                 .and. x(iatom,imovie) .gt. l_3)then
                     i=i+1      
                     ndx_OW_l3(i)=iatom
              endif
          enddo 
      ...
      do imovie=1,nmovie
          do iatom=1,natoms
              if (trim(atom_type(iatom)) .eq. 'O' &
                 .and. x(iatom,imovie) .gt. l_4)then
                     i=i+1      
                     ndx_OW_l4(i)=iatom
              endif
          enddo 
      ...
      do imovie=1,nmovie
          do iatom=1,natoms
              if (trim(atom_type(iatom)) .eq. 'O' &
                 .and. x(iatom,imovie) .gt. l_5)then
                     i=i+1      
                     ndx_OW_l5(i)=iatom
              endif
          enddo 
      ...
      do imovie=1,nmovie
          do iatom=1,natoms
              if (trim(atom_type(iatom)) .eq. 'O' &
                 .and. x(iatom,imovie) .gt. l_6)then
                     i=i+1      
                     ndx_OW_l6(i)=iatom
              endif
          enddo 
      ...
      do imovie=1,nmovie
          do iatom=1,natoms
              if (trim(atom_type(iatom)) .eq. 'O' &
                 .and. x(iatom,imovie) .gt. l_7)then
                     i=i+1      
                     ndx_OW_l7(i)=iatom
              endif
          enddo 
      ...
      do imovie=1,nmovie
          do iatom=1,natoms
              if (trim(atom_type(iatom)) .eq. 'O' &
                 .and. x(iatom,imovie) .gt. l_8)then
                     i=i+1      
                     ndx_OW_l8(i)=iatom
              endif
          enddo 
      ...
      do imovie=1,nmovie
          do iatom=1,natoms
              if (trim(atom_type(iatom)) .eq. 'O' &
                 .and. x(iatom,imovie) .gt. l_9)then
                     i=i+1      
                     ndx_OW_l9(i)=iatom
              endif
          enddo 
      ...
      do imovie=1,nmovie
          do iatom=1,natoms
              if (trim(atom_type(iatom)) .eq. 'O' &
                 .and. x(iatom,imovie) .gt. l_10)then
                     i=i+1      
                     ndx_OW_l10(i)=iatom
              endif
          enddo 
...
!Print the list      
!==============
      open(20,file=trim(filename)//'_salty_list.dat')
...
!====================================
      open(20,file=trim(filename)//'_salty_l1_list.dat')
      ...
      enddo
      close(20)
      open(20,file=trim(filename)//'_salty_l2_list.dat')
      ...
      enddo
      close(20)
      open(20,file=trim(filename)//'_salty_l3_list.dat')
      ...
      enddo
      close(20)
      open(20,file=trim(filename)//'_salty_l4_list.dat')
      ...
      enddo
      close(20)
      open(20,file=trim(filename)//'_salty_l5_list.dat')
      ...
      enddo
      close(20)
      open(20,file=trim(filename)//'_salty_l6_list.dat')
      ...
      enddo
      close(20)
      open(20,file=trim(filename)//'_salty_l7_list.dat')
      ...
      enddo
      close(20)
      open(20,file=trim(filename)//'_salty_l8_list.dat')
      ...
      enddo
      close(20)
      open(20,file=trim(filename)//'_salty_l9_list.dat')
      do i1=1, i_OW_l9-1! No O atom can not be bonded to itself 
          m1=ndx_OW_l9(i1)
          do i2=i1+1, i_OW_l9
              m2=ndx_OW_l9(i2)
              do ii=1,i_H
      ...
      enddo
      close(20)
      open(20,file=trim(filename)//'_salty_l10_list.dat')
      do i1=1, i_OW_l10-1! No O atom can not be bonded to itself 
          m1=ndx_OW_l10(i1)
          do i2=i1+1, i_OW_l10
              m2=ndx_OW_l10(i2)
              do ii=1,i_H
      ...
      deallocate(ndx_OW,ndx_OW_l1,ndx_OW_l2,ndx_OW_l3,&
                 ...
                 ndx_OW_l8,ndx_OW_l9,ndx_OW_l10,ndx_H,x,y,z)
!==============================================================
