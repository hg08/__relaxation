...
!  In this function, we calculate the relaxiation of just ONE O-H bond, and we find the the last 
!  value of the auto correlation function is ZERO .This value is likely an ERROR! 
!  We find that the auto correlation function is alway larger a positive value (even close to 1), 
!  idicating that the O-H bond has never breaking in this such a short time period.  
!================================================================================================
