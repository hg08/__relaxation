...
!==================
      ...
      allocate(y(nat,nmo))
      allocate(z(nat,nmo))
      allocate(x1(nat,nmo)) ! FOR PBC
      allocate(y1(nat,nmo)) ! FOR PBC
      allocate(z1(nat,nmo)) ! FOR PBC
      allocate(h(nmo))
...
!=============      
      do k=1,np
        ...
        do jj =1, nmo
          ...
          r13_2= (x(m1,jj)-x(m3,jj))**2+       &
                    (y(m1,jj)-y(m3,jj))**2+  &
                    (z(m1,jj)-z(m3,jj))**2!r12,r13,r23:square of distances
          r12_2= (x1(m1,jj)-x1(m2,jj))**2+       &
                    (y1(m1,jj)-y1(m2,jj))**2+  &
                    (z1(m1,jj)-z1(m2,jj))**2
