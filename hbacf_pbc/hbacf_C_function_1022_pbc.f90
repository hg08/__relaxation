...
!==========
      ...
      ! Information about a specific potential hydrogen bond
      ! Used to store the main information about an atom which makes a hydroben bond
      ! The 3-body-collection, which can have a bonding state, named hydrogen bond occupation (h(t)), whose value is unit (we can also generalize it to a unit vector) or zero.
      type :: info_hbond
          integer :: index_atom1
          integer :: index_atom2
          integer :: index_atom3
          REAL(kind=8),dimension(3) :: cos ! Cosine of the angle between the HYDROGEN BOND and the X,Y,Z axis
          REAL(kind=8) :: dist12 ! Distance square between the atom1 and atom2
          REAL(kind=8) :: dist13 ! Distance square between the atom1 and atom3
          REAL(kind=8) :: cos_phi ! Cosine of the angle atom1-atom2-atom3
      end type info_3body
...
!=============      
      do k=1,np
        ...
        do jj =1, nmo
          ...
          !========================================
          r13_1= r13 ! Both atom 1 and 3 are in image cell 
          ...
          r12_4= (x(m1,jj)-x1(m2,jj))**2+       &
                    (y(m1,jj)-y1(m2,jj))**2+  &
                    (z(m1,jj)-z1(m2,jj))**2
          r23_4= r23 ! Both atoms are in the image cell
          ...
          r12_44= r12_33
          r23_44= r23 ! Both atoms are in the same image cell
          ...
          r13_66=r13_22
          r12_66= r12 !Both atoms are in the same image cell
          r23_66= r23_33
          ...
          if (                                       & 
             ...
             (r13_66 .lt. rohc .and. r12_66 .lt. rooc      & 
             .and. cosphi_66 .gt. cosphic) .or.         &
             (r13_55 .lt. rohc .and. r12_55 .lt. rooc      & 
             .and. cosphi_55 .gt. cosphic) .or.         &
             ...
             (r13_6 .lt. rohc .and. r12_6 .lt. rooc      & 
             .and. cosphi_6 .gt. cosphic) .or.         &
      ...
      enddo!End of k-loop 
      deallocate(hb_exist,nhb_exist,x,y,z,x1,y1,z1,x11,y11,z11,&
                 ndx_1,ndx_2,ndx_3)         
      !=========================================
