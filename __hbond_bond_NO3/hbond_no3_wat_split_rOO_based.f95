...
!===========================
!===========================================================================      
! The function 'hbond_no3_wat_split_rOO_based.f95' is different from 'hbond
! _shell2_hal.f90', because there are O atoms in NO3- ions, we can print 
! '*_NitrateO-Ow-Hw_list.dat' and '*_OW-OW-HW_list.dat'.
! In this function, we use Nitrate-O-OW distance to determine the water
! molecules in the NO3--shell. (But one Problem: repeated indices of atoms!)      
!===========================================================================      
...
! input filename 'input': 
     ...
     ! 3rd line: number of steps
     ! 4th line: number of atoms
     ! 5th line: len_piece
     ! 6th line: r_OO
!========================
...
!========================
      ...
      real(kind=rk) :: r_ON,r_OO,r23,rooc
...
!==================
      ...
      read(5,*)len_piece    
      write(6,*)'What is the cutoff dist of Nit_O-OW distance r_OO(A):'
      read(5,*)rooc
...
!=======================
      ...
      do j_slide=1,kmovie
         ...
         write(6,*)x(iatom-1,j_slide), "x, FOR TESTING." ! FOR TESTING
           ...
           !=====================================
           do j=1, len_piece*(natoms+2)/(2*20)
